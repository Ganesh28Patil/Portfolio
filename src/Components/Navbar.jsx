...
export default function Navbar() {
    ...
    return (
        <Nav>
            <NavCont>
                <Logo onClick={()=> scroll.scrollToTop()}>GP</Logo>
                <Menu>
                    ...
                    <Resume> <a href="https://drive.google.com/file/d/1LMWO9x_Zn9xD2fDYKCJNysWy6ywKwY-Q/view?usp=sharing" target="_blank" rel="noopener noreferrer">Resume</a></Resume>
                </Menu>
            </NavCont>
        </Nav>
    )
